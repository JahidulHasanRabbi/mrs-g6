...
| \# | Property/Field | Data Type | Nullable | Description |
| ----: | :---- | :---- | :---- | :---- |
| **1** | upgrade\_bonus | Decimal or Bool | No | If claimable, returns Decimal, if not, returns False |
| **2** | birthday\_bonus | Decimal or Bool | No | If claimable, returns Decimal, if not, returns False |
...
/third-party/claim-monthly/ POST

### Claim VIP \- Birthday

/third-party/claim-birthday/ POST

### Claim VIP \- Upgrade

/third-party/claim-upgrade/ POST

Input for all 3

| \# | Property/Field | Data Type | Nullable | Description |
| ----: | :---- | :---- | :---- | :---- |
| **1** | special\_code | str | No |  |
| **2** | user\_id | str | No |  |

Returns 404 if any error, 200 if claimed successfully. 400 if station cannot process and need to try again,