...
const VIP_LEVELS = [
  { name: "Bronze", badge: VIP_DETAILS_ASSETS.badges.bronze, rotation: 16.31, top: 10, left: 30 },
  { name: "Silver", badge: VIP_DETAILS_ASSETS.badges.silver, rotation: 10.1, top: 27, left: 120 },
  { name: "Gold", badge: VIP_DETAILS_ASSETS.badges.gold, rotation: 0, top: 38, left: 210 },
  { name: "Platinum", badge: VIP_DETAILS_ASSETS.badges.platinum, rotation: -10, top: 30, left: 300 },
  { name: "Diamond", badge: VIP_DETAILS_ASSETS.badges.diamond, rotation: -20, top: 8, left: 390 },
];
    ...
    <div className="relative w-full h-[120px] flex justify-center items-center">
      ...
      >
        ...
        {VIP_LEVELS.map((level, index) => {
          ...
          const topPos = isSelected ? level.top - 9 : level.top;
