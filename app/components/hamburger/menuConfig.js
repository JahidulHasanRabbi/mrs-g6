  ...
  mainItems: [
    {
      ...
      link: "/leaderboard",
      children: [
        { icon: "/assets/menu-icons/leaderboard.svg", label: "WorldCup Leaderboard", link: "/leaderboard" },
        { icon: "/assets/menu-icons/deposit.svg", label: "Top 20 Deposit", link: "/leaderboard/top-20?tab=deposit" },
        { icon: "/assets/menu-icons/withdrawal.svg", label: "Top 20 Withdraw", link: "/leaderboard/top-20?tab=withdrawal" },
        { icon: "/assets/menu-icons/referral.svg", label: "Top 20 Referral", link: "/leaderboard/top-20?tab=referrer" },
      ],
    },
