...
/**
 * Ubetclub VIP Details — mirrors the acebet77 VIP page: same logic and
 * functionality as the default /vip page (VipLevelChain + PrivilegesCarousel,
 * same getVipTiers / mapVipTiers pipeline). Only the title banner asset
 * changes to the ubetclub gold plaque. The tier card background is swapped
 * by <PrivilegesCard> based on theme; no logic changes here.
 */
export default function UbetclubVipPage() {
