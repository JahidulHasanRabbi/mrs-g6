            ...
            {[
              ...
              >
                ...
                <span className="relative z-10 flex flex-col items-center justify-center gap-0.5 leading-[1.1]">
                  <span className="whitespace-nowrap text-[5.5cqi]" style={{ fontFamily: 'var(--font-rubik), sans-serif', color: KGAME99_COLORS.cream }}>
                    {btn.tokens} Token
                  </span>
                  <span className="whitespace-nowrap text-[7.8cqi] leading-none" style={{ fontFamily: 'var(--font-berkshire-swash), cursive', color: KGAME99_COLORS.goldBright }}>
                    {btn.spins}
                  </span>
                </span>
              </button>
