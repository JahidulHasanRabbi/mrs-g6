...
/**
 * Kgame99 ornate dialog card — the single Figma frame (154:166 dialog frame)
 ...
 */
export default function KgameOrnateCard({ children, className = "" }) {
  return (
    <div
      className={`relative mx-auto aspect-[3/2] w-full max-w-[360px] ${className}`}
      style={{
        backgroundImage: `url(${KGAME99_ASSETS.ui.dialogFrame})`,
