...
const NAV_ITEMS = [
  { id: 'leaderboard', icon: KGAME99_ASSETS.nav.leaderboard, label: 'LEADERBOARD', link: '/leaderboard', width: 34, height: 40 },
  { id: 'hot', icon: KGAME99_ASSETS.nav.hot, label: 'HOT', action: 'hot', width: 34, height: 40 },
  { id: 'home', icon: KGAME99_ASSETS.nav.home, label: 'HOME', link: '/', width: 50, height: 58, isCenter: true },
  { id: 'profile', icon: KGAME99_ASSETS.nav.profile, label: 'PROFILE', link: '/profile', width: 34, height: 40 },
  { id: 'livechat', icon: KGAME99_ASSETS.nav.livechat, label: 'LIVECHAT', action: 'livechat', width: 34, height: 40 },
];
    ...
    >
      ...
      >
        {/* Plain <img>, not next/image: at these small render widths (~48px)
            ...
            applied everywhere else in the kgame99 theme. */}
        <img
          src={item.icon}
          alt={item.label}
          draggable={false}
      ...
      <p
        ...
        style={{
          ...
          color: isActive ? '#ffffff' : KGAME99_COLORS.gold,
...
/**
 * Kgame99 bottom navigation — ornate blue bar with raised center crest
 * (LEADERBOARD / HOT / HOME / PROFILE / LIVECHAT).
 */
function KgameBottomNav() {
...
export default memo(KgameBottomNav);
