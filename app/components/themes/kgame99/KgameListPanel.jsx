...
export default function KgameListPanel({ children, height = 300, className = '' }) {
  return (
    ...
    >
      {/* Content sits directly over the frame's light castle-cloud interior —
          no dark scrim (that read as an ugly black box). Panel text is dark
          navy so it stays legible against the bright interior. */}
