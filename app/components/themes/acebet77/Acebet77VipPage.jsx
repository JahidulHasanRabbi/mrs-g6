...
/**
 * Acebet77 VIP Details — same logic and functionality as the default
 * app/vip/page.js (same VipLevelChain + PrivilegesCarousel driven by the same
 * getVipTiers / mapVipTiers pipeline). The ONLY difference is the title
 * banner asset: the default portal shows the green "VIP Details" banner via
 * AnimatedSection, this page shows the acebet77 gold "VIP Details" plaque.
 * No content, functionality, or data is changed.
 */
export default function Acebet77VipPage() {
  ...
  return (
    <>
      {/* Asset swap: acebet77 gold "VIP Details" plaque in place of the
          default green AnimatedSection banner. Everything below is the
          default VIP page render, byte-for-byte. */}
      <div className="flex w-full justify-center pt-2">
        <motion.img
          src={ACEBET_ASSETS.vip.title}
          alt="VIP Details"
          draggable={false}
