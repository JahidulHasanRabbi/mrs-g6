    ...
    >
      ...
      <p
        ...
        style={{
          ...
          color: isActive ? '#ffffff' : ACEBET_COLORS.gold,
...
/**
 * Acebet77 bottom navigation — ornate gold bar with raised center crest
 * (LEADERBOARD / HOT / HOME / PROFILE / LIVECHAT).
 */
function AcebetBottomNav() {
...
export default memo(AcebetBottomNav);
