...
/**
 * Acebet77 modal: blurred dark backdrop + crowned ornate gold frame.
 * Children render inside the frame's safe area.
 */
export default function AcebetDialog({ open, onClose, children, tall = false, frameless = false }) {
  return (
    <AnimatePresence>
      {open && (
        <motion.div
        ...
        >
          ...
          {frameless ? (
            ...
            // AcebetOrnateCard) plus any buttons that sit below the frame.
            ...
            >
              <img
                src={tall ? ACEBET_ASSETS.ui.dialogFrameTall : ACEBET_ASSETS.ui.dialogFrame}
                alt=""
