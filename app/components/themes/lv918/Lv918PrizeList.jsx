            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="break-words text-[13px] leading-[18px]" style={{ fontFamily: 'var(--font-rubik), sans-serif', color: LV918_COLORS.inkStrong }}>
                    {prize.name}
                  </p>
                </div>
                {r.badge && (
          ...
          {creditRanges.length > 0 && (
            <div className="mt-1 grid grid-cols-2 gap-1.5">
              {creditRanges.map((credit, i) => (
                <div key={`${credit.label}-${i}`} className="flex items-center gap-1.5 rounded-md bg-[rgba(255,255,255,0.42)] px-2 py-1.5 ring-1 ring-inset ring-[rgba(197,140,60,0.35)]">
                  {credit.image ? (
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="break-words text-[9px] leading-[12px]" style={{ fontFamily: 'var(--font-rubik), sans-serif', color: LV918_COLORS.inkStrong }}>{credit.label}</p>
                  </div>
                </div>
              ))}
            </div>
