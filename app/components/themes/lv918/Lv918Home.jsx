...
const GAME_TILES = [
  { id: 'lucky-spin', image: LV918_ASSETS.home.tileLuckySpin, label: 'Lucky Spin', link: '/spin' },
  { id: 'penalty-kick', image: LV918_ASSETS.home.tilePenaltyKick, label: 'Penalty Kick', link: '/penalty-kick' },
  { id: 'smash-egg', image: LV918_ASSETS.home.tileSmashEgg, label: 'Smash Egg', link: '/smash-egg' },
];

/**
 * Lv918 main menu (Figma node 154:773): celestial "crystal kingdom" backdrop
 * with the crowned queen standing on the platform (left), the Lv918 crest and
  ...
  return (
    ...
    >
      <div className="relative h-[calc(100dvh-184px)] w-full">
        {/* Lv918 crest — centred over the scene. Width is viewport-fluid so it
