...
/**
 * Lv918 modal: blurred dark backdrop + crowned ornate frame.
 * Children render inside the frame's safe area.
 */
export default function Lv918Dialog({ open, onClose, children, tall = false, frameless = false }) {
  return (
    <AnimatePresence>
      {open && (
        <motion.div
        ...
        >
          ...
          {frameless ? (
            ...
            // Lv918OrnateCard) plus any buttons that sit below the frame.
            ...
            >
              <img
                src={tall ? LV918_ASSETS.ui.dialogFrameTall : LV918_ASSETS.ui.dialogFrame}
                alt=""
