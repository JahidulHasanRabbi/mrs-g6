...
const GAME_TILES = [
  { id: 'lucky-spin', image: N1GANG_ASSETS.home.tileLuckySpin, label: 'Lucky Spin', link: '/spin' },
  { id: 'smash-egg', image: N1GANG_ASSETS.home.tileSmashEgg, label: 'Smash Egg', link: '/smash-egg' },
  { id: 'penalty-kick', image: N1GANG_ASSETS.home.tilePenaltyKick, label: 'Penalty Kick', link: '/penalty-kick' },
];
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-[10px] min-h-[calc(100vh-184px)] px-4">
        ...
        >
          <Image src={N1GANG_ASSETS.home.crest} alt="N1gang" fill priority className="object-contain" sizes="206px" />
        </motion.div>
