...
export default function MartHeader({ balance = "5,450.00", onMenuClick, onProfileClick }) {
  return (
    <motion.div 
    ...
    >
      ...
      <motion.button
        onClick={onMenuClick}
        className="absolute left-[21px] top-[14px] flex flex-col items-center gap-1"
      ...
      <motion.button
        ...
        className="absolute right-[21px] top-[14px] w-[52px] h-[52px]"
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
      >
        <Image
