...
import ImageCell from "../../world-cup/ImageCell";

const HEADER_BG = "linear-gradient(180deg, #141828 0%, #333333 99.75%)";

export default function TurnoverRewardTable({ rewards = [], onEdit, onArchive }) {
  return (
        ...
        <table className="w-full min-w-[900px]">
          <thead>
            <tr style={{ backgroundImage: HEADER_BG }} className="text-left">
              ...
              <th className="px-5 py-4 text-[13px] font-semibold text-[#fbeed2]">Rank Position</th>
          ...
          <tbody>
            {rewards.length === 0 ? (
              <tr>
                <td colSpan={6} className="px-5 py-10 text-center text-[13px] text-white/50">
