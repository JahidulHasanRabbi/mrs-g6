        ...
        <table className="w-full min-w-[1000px]">
          <thead>
            <tr style={{ backgroundImage: HEADER_BG }} className="text-left">
              <th className="px-5 py-4 text-[13px] font-semibold text-[#fbeed2]">Location</th>
            ...
            {banners.length === 0 ? (
              ...
              banners.map((b) => (
                <tr key={b.id} className="border-b border-white/5 align-top last:border-b-0 hover:bg-white/[0.02]">
                  <td className="px-5 py-5 text-[12px] font-medium uppercase text-white">{b.locationLabel}</td>
