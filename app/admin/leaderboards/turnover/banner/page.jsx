...
import {
  getTurnoverBanner,
  createTurnoverBanner,
  updateTurnoverBanner,
} from "../../../../api/adminApi";
...
function BannerForm() {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      if (editingUuid) {
        await updateTurnoverBanner(editingUuid, payload);
      } else {
        await createTurnoverBanner(payload);
      }
...
export default function AddTurnoverBannerPage() {
  return (
