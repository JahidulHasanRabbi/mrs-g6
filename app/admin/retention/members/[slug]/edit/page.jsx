...
function formToApi(form, vipTiers = [], originalData = null) {
  ...
  return {
    profile_data: {
      ...
      tags: Array.isArray(existingProfile.tags) ? existingProfile.tags : undefined,
      wallet_levels: Array.isArray(existingProfile.wallet_levels) ? existingProfile.wallet_levels : undefined,
