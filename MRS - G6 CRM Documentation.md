...
| **11** | repeat\_rate | List | \- | See Repeat Rate below |
| **12** | repeat\_rate\_\_total | Int | No |  |
...
| **8** | sales | str | Yes | “High” “Low” |
| **9** | win\_lose | str | Yes | “High” “Low” |
| **10** | followed\_up | bool | Yes | “true”  “false” |
...
## Error Transactions  \- GET

/crm-members/error-transactions/ GET

| \# | Property/Field | Data Type | Nullable | Description |
| ----: | :---- | :---- | :---- | :---- |
| **1** | uuid | uuid | No |  |
| **2** | phone\_number | str | Yes |  |
| **3** | amount | Decimal | No |  |
| **4** | transaction\_id | Int | No |  |
| **5** | transaction\_date | datetime | No |  |
| **6** | source\_type | Str | No | Returns Deposit, Withdraw, or Bonus |

/crm-members/error-transactions/clear-error/ PATCH

Input

| \# | Property/Field | Data Type | Nullable | Description |
| ----: | :---- | :---- | :---- | :---- |
| **1** | source\_type | str | No | Use Deposit, Withdraw or Bonus |
| **2** | uuid | uuid | No |  |

/crm-members/error-transactions/delete-transaction/ DELETE
...
# Member Monthly Comparison  \- GET

/crm-members/member-comparison/ GET
...
| \# | Property/Field | Data Type | Nullable | Description |
| ----: | :---- | :---- | :---- | :---- |
| **1** | month | yyyy-mm | No | Default to this month |
| **2** | brand | str | Yes | iexact, looks for brand shortforms |
| **3** | vip\_level | str | Yes | iexact, looks for tier names |
| **4** | pic | str | Yes | iexact, looks for pic names |
| **5** | search | str | Yes | icontains, looks for member full name or member phone number |
...
| ----: | :---- | :---- | :---- | :---- |
| **1** | uuid | uuid | No |  |
| **2** | username | str | Yes | Returns member full name |
| **3** | brand | str | No |  |
| **4** | phone\_number | str | No |  |
| **5** | vip\_level | str | No |  |
| **6** | last\_active | date | Yes |  |
| **7** | last\_followed\_up\_by | str | Yes | Returns admin name |
| **8** | last\_followed\_up\_date | date | Yes |  |
| **9** | follow\_up\_status | Str | Yes | Returns “FOLLOWED\_UP” , “NOT\_FOLLOWED\_UP”, or “N/A” |
| **10** | this\_month\_deposit | Decimal | No |  |
| **11** | this\_month\_win\_loss | Decimal | No |  |
| **12** | last\_month\_deposit | Decimal | No |  |
| **13** | last\_month\_win\_loss | Decimal | No |  |
